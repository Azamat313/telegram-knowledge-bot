...
KASPI_PRICE_KZT = int(os.getenv("KASPI_PRICE_KZT", "990"))
...
# Messages
MSG_WELCOME = (
    "Ассалаумағалейкум! Мен — Рамазан айына қатысты сұрақтарға жауап беретін ЖИ бот-көмекшімін.\n\n"
...
MSG_AI_ERROR = "Кешіріңіз, ЖИ сервисінде уақытша қате орын алды. Сәл күтіп, қайталап көріңіз."
...
MSG_PAYMENT_SUCCESS = (
    ...
    "Тариф: {plan_label}\n"
    "Мерзімі: {expires_at} дейін\n\n"
    "Жақсы пайдалану тілейміз!"
)

MSG_PAYMENT_TITLE = "Рамазан ЖИ бот — жазылым"
MSG_PAYMENT_DESCRIPTION = "Шексіз жауаптар + устазға сұрақ қою мүмкіндігі"
